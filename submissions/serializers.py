...
class SubmissionSerializer(serializers.HyperlinkedModelSerializer):
    class Meta:
        ...
        fields = [
            ...
            'film_link', 'film_link_pwd', 'attend', 'backlink', 'director',
            'director_address', 'director_email', 'director_site',
            'director_phone', 'producer', 'producer_address', 'producer_email',
            'producer_site', 'producer_phone', 'screenwriter', 'editor',
            'music', 'director_photography', 'other_credits', 'allow_tv',
