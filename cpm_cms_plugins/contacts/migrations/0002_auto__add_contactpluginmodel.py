...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cmsplugin_contactpluginmodel', (
            ...
            ('contact_email', self.gf('django.db.models.fields.EmailField')(max_length=100)),
            ('contact_skype', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('additional_info', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('contacts', ['ContactPluginModel'])
    ...
    models = {
        ...
        'contacts.contactpluginmodel': {
            ...
            'contact_skype': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        }
    }
