...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('cpm2013_submission', 'preview',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Submission.previewers'
        db.add_column('cpm2013_submission', 'previewers',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('cpm2013_submission', 'preview')

        # Deleting field 'Submission.previewers'
        db.delete_column('cpm2013_submission', 'previewers')
