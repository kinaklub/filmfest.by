...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PreviewMark'
        db.create_table('cpm2013_previewmark', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('previewer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cpm2013.Previewer'])),
            ('submission', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cpm2013.Submission'])),
            ('mark', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('cpm2013', ['PreviewMark'])

        # Adding model 'Previewer'
        db.create_table('cpm2013_previewer', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('occupation_cinema', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('education', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('working', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('participation_in_film_creation', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('how_often_watch', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('how_often_screenings', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('cinephilia', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('coefficient', self.gf('django.db.models.fields.FloatField')(default=1.0)),
        ))
        db.send_create_signal('cpm2013', ['Previewer'])


    def backwards(self, orm):
        # Deleting model 'PreviewMark'
        db.delete_table('cpm2013_previewmark')

        # Deleting model 'Previewer'
        db.delete_table('cpm2013_previewer')
    ...
    models = {
        ...
        'cpm2013.previewer': {
            ...
            'occupation_cinema': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'participation_in_film_creation': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
