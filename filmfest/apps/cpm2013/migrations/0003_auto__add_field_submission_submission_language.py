...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Submission.submission_language'
        db.add_column('cpm2013_submission', 'submission_language',
                      self.gf('django.db.models.fields.CharField')(default='en', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Submission.submission_language'
        db.delete_column('cpm2013_submission', 'submission_language')
