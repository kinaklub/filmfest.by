...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Submission.received_screenshots'
        db.add_column('cpm2013_submission', 'received_screenshots',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Submission.received_director_photo'
        db.add_column('cpm2013_submission', 'received_director_photo',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Submission.received_director_bio'
        db.add_column('cpm2013_submission', 'received_director_bio',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Submission.received_producer_photo'
        db.add_column('cpm2013_submission', 'received_producer_photo',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Submission.received_producer_bio'
        db.add_column('cpm2013_submission', 'received_producer_bio',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Submission.received_company_info'
        db.add_column('cpm2013_submission', 'received_company_info',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Submission.received_company_logo'
        db.add_column('cpm2013_submission', 'received_company_logo',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Submission.received_viza_info'
        db.add_column('cpm2013_submission', 'received_viza_info',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Submission.received_screenshots'
        db.delete_column('cpm2013_submission', 'received_screenshots')

        # Deleting field 'Submission.received_director_photo'
        db.delete_column('cpm2013_submission', 'received_director_photo')

        # Deleting field 'Submission.received_director_bio'
        db.delete_column('cpm2013_submission', 'received_director_bio')

        # Deleting field 'Submission.received_producer_photo'
        db.delete_column('cpm2013_submission', 'received_producer_photo')

        # Deleting field 'Submission.received_producer_bio'
        db.delete_column('cpm2013_submission', 'received_producer_bio')

        # Deleting field 'Submission.received_company_info'
        db.delete_column('cpm2013_submission', 'received_company_info')

        # Deleting field 'Submission.received_company_logo'
        db.delete_column('cpm2013_submission', 'received_company_logo')

        # Deleting field 'Submission.received_viza_info'
        db.delete_column('cpm2013_submission', 'received_viza_info')
