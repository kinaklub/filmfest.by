...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Previewer.participation_in_film_creation'
        db.alter_column('cpm2013_previewer', 'participation_in_film_creation', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Previewer.occupation_cinema'
        db.alter_column('cpm2013_previewer', 'occupation_cinema', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Previewer.participation_in_film_creation'
        db.alter_column('cpm2013_previewer', 'participation_in_film_creation', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Previewer.occupation_cinema'
        db.alter_column('cpm2013_previewer', 'occupation_cinema', self.gf('django.db.models.fields.IntegerField')())
