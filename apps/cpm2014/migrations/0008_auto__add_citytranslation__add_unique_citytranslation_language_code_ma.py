...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cpm2014_city_translation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=1000)),
            ('language_code', self.gf('django.db.models.fields.CharField')(max_length=15, db_index=True)),
            ('master', self.gf('django.db.models.fields.related.ForeignKey')(related_name='translations', null=True, to=orm['cpm2014.City'])),
        ))
        db.send_create_signal('cpm2014', ['CityTranslation'])

        # Adding unique constraint on 'CityTranslation', fields ['language_code', 'master']
        db.create_unique('cpm2014_city_translation', ['language_code', 'master_id'])

        # Adding model 'EventTranslation'
        db.create_table('cpm2014_event_translation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=1000)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('language_code', self.gf('django.db.models.fields.CharField')(max_length=15, db_index=True)),
            ('master', self.gf('django.db.models.fields.related.ForeignKey')(related_name='translations', null=True, to=orm['cpm2014.Event'])),
        ))
        db.send_create_signal('cpm2014', ['EventTranslation'])

        # Adding unique constraint on 'EventTranslation', fields ['language_code', 'master']
        db.create_unique('cpm2014_event_translation', ['language_code', 'master_id'])

        # Adding model 'PlaceTranslation'
        db.create_table('cpm2014_place_translation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=1000)),
            ('address', self.gf('django.db.models.fields.CharField')(max_length=1000)),
            ('language_code', self.gf('django.db.models.fields.CharField')(max_length=15, db_index=True)),
            ('master', self.gf('django.db.models.fields.related.ForeignKey')(related_name='translations', null=True, to=orm['cpm2014.Place'])),
        ))
        db.send_create_signal('cpm2014', ['PlaceTranslation'])

        # Adding unique constraint on 'PlaceTranslation', fields ['language_code', 'master']
        db.create_unique('cpm2014_place_translation', ['language_code', 'master_id'])

        # Adding model 'Place'
        db.create_table('cpm2014_place', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('code', self.gf('django.db.models.fields.CharField')(max_length=1000)),
            ('city', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cpm2014.City'])),
        ))
        db.send_create_signal('cpm2014', ['Place'])

        # Adding model 'City'
        db.create_table('cpm2014_city', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('code', self.gf('django.db.models.fields.CharField')(max_length=1000)),
            ('priority', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('cpm2014', ['City'])

        # Adding model 'Event'
        db.create_table('cpm2014_event', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('code', self.gf('django.db.models.fields.CharField')(max_length=1000)),
            ('starts_at', self.gf('django.db.models.fields.DateTimeField')(db_index=True)),
            ('place', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cpm2014.Place'])),
        ))
        db.send_create_signal('cpm2014', ['Event'])


    def backwards(self, orm):
        # Removing unique constraint on 'PlaceTranslation', fields ['language_code', 'master']
        db.delete_unique('cpm2014_place_translation', ['language_code', 'master_id'])

        # Removing unique constraint on 'EventTranslation', fields ['language_code', 'master']
        db.delete_unique('cpm2014_event_translation', ['language_code', 'master_id'])

        # Removing unique constraint on 'CityTranslation', fields ['language_code', 'master']
        db.delete_unique('cpm2014_city_translation', ['language_code', 'master_id'])

        # Deleting model 'CityTranslation'
        db.delete_table('cpm2014_city_translation')

        # Deleting model 'EventTranslation'
        db.delete_table('cpm2014_event_translation')

        # Deleting model 'PlaceTranslation'
        db.delete_table('cpm2014_place_translation')

        # Deleting model 'Place'
        db.delete_table('cpm2014_place')

        # Deleting model 'City'
        db.delete_table('cpm2014_city')

        # Deleting model 'Event'
        db.delete_table('cpm2014_event')
