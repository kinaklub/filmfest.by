...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('cpm2014_event', 'program',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cpm2014.Program'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.program'
        db.delete_column('cpm2014_event', 'program_id')
    ...
    models = {
        ...
        'cpm2014.event': {
            ...
            'program': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cpm2014.Program']", 'null': 'True'}),
