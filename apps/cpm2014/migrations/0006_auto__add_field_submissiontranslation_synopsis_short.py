...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubmissionTranslation.synopsis_short'
        db.add_column('cpm2014_submissiontranslation', 'synopsis_short',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubmissionTranslation.synopsis_short'
        db.delete_column('cpm2014_submissiontranslation', 'synopsis_short')
