...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Submission.preview_average'
        db.add_column('cpm2013_submission', 'preview_average',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Submission.preview_average'
        db.delete_column('cpm2013_submission', 'preview_average')
