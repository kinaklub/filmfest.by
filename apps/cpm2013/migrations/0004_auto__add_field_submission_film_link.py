...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Submission.film_link'
        db.add_column('cpm2013_submission', 'film_link',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1000, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Submission.film_link'
        db.delete_column('cpm2013_submission', 'film_link')
