...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Submission.submitted_at'
        db.add_column('cpm2013_submission', 'submitted_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime.now(), blank=True),
                      keep_default=False)

        # Adding field 'Submission.email_sent_at'
        db.add_column('cpm2013_submission', 'email_sent_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True, default=datetime.datetime.now(), ),
                      keep_default=False)

        # Adding field 'Submission.film_received_at'
        db.add_column('cpm2013_submission', 'film_received_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Submission.papers_received_at'
        db.add_column('cpm2013_submission', 'papers_received_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Submission.submitted_at'
        db.delete_column('cpm2013_submission', 'submitted_at')

        # Deleting field 'Submission.email_sent_at'
        db.delete_column('cpm2013_submission', 'email_sent_at')

        # Deleting field 'Submission.film_received_at'
        db.delete_column('cpm2013_submission', 'film_received_at')

        # Deleting field 'Submission.papers_received_at'
        db.delete_column('cpm2013_submission', 'papers_received_at')
