...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SubmissionFileUpload'
        db.create_table('cpm2013_submissionfileupload', (
            ...
            ('real_name', self.gf('django.db.models.fields.CharField')(max_length=355)),
        ))
        db.send_create_signal('cpm2013', ['SubmissionFileUpload'])


    def backwards(self, orm):
        # Deleting model 'SubmissionFileUpload'
        db.delete_table('cpm2013_submissionfileupload')
    ...
    models = {
        ...
        'cpm2013.submissionfileupload': {
            'Meta': {'object_name': 'SubmissionFileUpload'},
            'display_name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'real_name': ('django.db.models.fields.CharField', [], {'max_length': '355'}),
            'submission': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cpm2013.Submission']"})
        }
    }
