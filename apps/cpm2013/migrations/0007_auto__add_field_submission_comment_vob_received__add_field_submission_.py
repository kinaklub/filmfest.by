...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Submission.comment_vob_received'
        db.add_column('cpm2013_submission', 'comment_vob_received',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Submission.vob_received_at'
        db.add_column('cpm2013_submission', 'vob_received_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Submission.comment_vob_received'
        db.delete_column('cpm2013_submission', 'comment_vob_received')

        # Deleting field 'Submission.vob_received_at'
        db.delete_column('cpm2013_submission', 'vob_received_at')
