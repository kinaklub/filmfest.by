...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FesthomeSubmission'
        db.create_table('festhome_import_festhomesubmission', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('submission', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['submissions.Submission'])),
            ('festhome_id', self.gf('django.db.models.fields.IntegerField')(db_index=True)),
        ))
        db.send_create_signal('festhome_import', ['FesthomeSubmission'])


    def backwards(self, orm):
        # Deleting model 'FesthomeSubmission'
        db.delete_table('festhome_import_festhomesubmission')


    models = {
        'festhome_import.festhomesubmission': {
            'Meta': {'object_name': 'FesthomeSubmission'},
            'festhome_id': ('django.db.models.fields.IntegerField', [], {'db_index': 'True'}),
